...
<ul class="w3-navbar w3-theme-d2 w3-top w3-left-align w3-large" style="z-index:4;">
  ...
  <li class="w3-hide-small"><a href="#" class="w3-white">Team Sports</a></li>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-padding-32 w3-container">
    <div class="w3-accodion w3-light-grey">
        <button onclick="comptourney('NBA')" class="w3-btn-block w3-theme-l1 w3-left-align">
            National Basketball Association (NBA)
        </button>
        <div id="NBA" class="w3-accordion-content w3-container">
        ...
        <button onclick="comptourney('NHL')" class="w3-btn-block w3-theme-l1 w3-left-align">
            National Hockey League (NHL)
        </button>
        <div id="NHL" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('NFL')" class="w3-btn-block w3-theme-l1 w3-left-align">
            National Football League (NFL)
        </button>
        <div id="NFL" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('MLB')" class="w3-btn-block w3-theme-l1 w3-left-align">
            Major League Baseball (MLB)
        </button>
        <div id="MLB" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('FIFA')" class="w3-btn-block w3-theme-l1 w3-left-align">
            FIFA
        </button>
        <div id="FIFA" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('NLL')" class="w3-btn-block w3-theme-l1 w3-left-align">
            National Lacrosse League (NLL)
        </button>
        <div id="NLL" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
