...
<ul class="w3-navbar w3-theme-d2 w3-top w3-left-align w3-large" style="z-index:4;">
  ...
  <li class="w3-hide-small"><a href="#" class="w3-white">Individual Sports</a></li>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-padding-32 w3-container">
    <div class="w3-accodion w3-light-grey">
        <button onclick="comptourney('PGA')" class="w3-btn-block w3-theme-l1 w3-left-align">
            PGA Tour
        </button>
        <div id="PGA" class="w3-accordion-content w3-container">
        ...
        <button onclick="comptourney('LPGA')" class="w3-btn-block w3-theme-l1 w3-left-align">
            LPGA Tour
        </button>
        <div id="LPGA" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('ATP')" class="w3-btn-block w3-theme-l1 w3-left-align">
            ATP World Tour
        </button>
        <div id="ATP" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('WTA')" class="w3-btn-block w3-theme-l1 w3-left-align">
            WTA Tour
        </button>
        <div id="WTA" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
