...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-padding-32 w3-container">
    <div class="w3-accodion w3-light-grey">
        <button onclick="comptourney('F1')" class="w3-btn-block w3-theme-l1 w3-left-align">
            Formula 1
        </button>
        <div id="F1" class="w3-accordion-content w3-container">
        ...
        <button onclick="comptourney('NASCAR')" class="w3-btn-block w3-theme-l1 w3-left-align">
            NASCAR
        </button>
        <div id="NASCAR" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('Indy')" class="w3-btn-block w3-theme-l1 w3-left-align">
            Indycar
        </button>
        <div id="Indy" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('ALMS')" class="w3-btn-block w3-theme-l1 w3-left-align">
            American Le Mans Series
        </button>
        <div id="ALMS" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
        ...
        <button onclick="comptourney('ELMS')" class="w3-btn-block w3-theme-l1 w3-left-align">
            European Le Mans Series
        </button>
        <div id="ELMS" class="w3-accordion-content w3-container">
            <div class="w3-container w3-border w3-next w3-center">
                Upcoming
            </div>
            <div class="w3-panel w3-border w3-center">
