...
<ul class="w3-navbar w3-purple w3-top w3-left-align w3-large" style="z-index:4;">
  ...
  <li class="w3-hide-small"><a href="Team_Sports.php" class="w3-white">Team Sports</a></li>
...
<!-- Sidenav -->
<nav class="w3-sidenav w3-collapse w3-red w3-animate-left" style="z-index:3;width:250px;margin-top:50px;" id="mySidenav">
...
<div class="w3-main" style="margin-left:250px">
  ...
  <article class="w3-container w3-padding-64">
    <div class="w3-container">
        <div class="w3-border-bottom w3-border-dark-grey">
            <h3>NBA 2016/2017 Regular Season</h3>
        </div>
    </div>
  </article>

  <article class="w3-container w3-padding-16">
    <div class="w3-container">
        <div class="w3-border-bottom w3-border-dark-grey">
            <h4>Overview</h4>
        </div>
  ...
  <article class="w3-container w3-padding-16">
    <div class="w3-container">
        <div class="w3-border-bottom w3-border-dark-grey">
            <h4>Injuries and Suspensions</h4>
        </div>
